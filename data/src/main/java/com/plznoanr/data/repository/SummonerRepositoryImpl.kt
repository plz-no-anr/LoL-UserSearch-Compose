...
import com.plznoanr.data.model.remote.asDomain
...
import com.plznoanr.data.utils.asSummonerList
import com.plznoanr.data.utils.catchResultError
import com.plznoanr.data.utils.toChampImage
import com.plznoanr.data.utils.toIcon
import com.plznoanr.data.utils.toSpellImage
import com.plznoanr.model.Spectator
import com.plznoanr.model.Summoner
import com.plznoanr.model.Team
...
class SummonerRepositoryImpl @Inject constructor(
    ...
    private suspend fun authTokenHeader() = HashMap<String, String>().apply {
        ...
        put("X-Riot-Token", "RGAPI-4c3bf6ca-906b-48b5-9226-c176ea03682d")
    }
